# Config for Powerlevel10k with 8-color lean prompt style
...
() {
  ...
  #typeset -g POWERLEVEL9K_LOCK_ICON='\Uf0250'
  ...
  typeset -g POWERLEVEL9K_DIR_DEFAULT_VISUAL_IDENTIFIER_EXPANSION=$'\Uf0dcf'
  typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_VISUAL_IDENTIFIER_EXPANSION=$'\Uf0770'
  ...
  ####################[ java_version: java version (https://www.java.com/) ]####################
  # Java version color.
  typeset -g POWERLEVEL9K_JAVA_VERSION_FOREGROUND=3
  ...
  # typeset -g POWERLEVEL9K_JAVA_VERSION_VISUAL_IDENTIFIER_EXPANSION=$'\Uf0176'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl|eksctl'
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_VISUAL_IDENTIFIER_EXPANSION=$'\Uf1062'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|cdk|eksctl|asp|asr|terraform|pulumi|terragrunt'
  ...
  typeset -g POWERLEVEL9K_BATTERY_STAGES=$'\Uf10cd\Uf007a\Uf007b\Uf007c\Uf007d\Uf007e\Uf007f\Uf0080\Uf0081\Uf0082\Uf0079'
  typeset -g POWERLEVEL9K_BATTERY_CHARGING_STAGES=$'\Uf0084'
  # Pictogram to show when the battery is fully charged and connected to power supply.
  typeset -g POWERLEVEL9K_BATTERY_CHARGED_VISUAL_IDENTIFIER_EXPANSION=$'\Uf0079'
  ...
  #################[ python_version: python version (https://www.python.org/) ]#################
  # Custom python version color.
  typeset -g POWERLEVEL9K_PYTHON_VERSION_FOREGROUND=3
  # typeset -g POWERLEVEL9K_PYTHON_VERSION_VISUAL_IDENTIFIER_EXPANSION='⭐'

  # TODO: This custom function could be improved with caching
  function prompt_python_version {
    [[ -n $VIRTUAL_ENV ]] && return
    _p9k_upglob '*.(py|pyz|pyc|pyi|pyd|pyo)' -. && return
    local v
    v="$(python --version 2>&1)" || return
    _p9k_prompt_segment "$0" "white" "yellow" "PYTHON_ICON" 0 '' "${v#* }"
  } 
